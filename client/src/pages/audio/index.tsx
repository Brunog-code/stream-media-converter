...
import ImgAudio from "../../assets/audio.webp";
    ...
    <Container>
      <section className={styles.container}>
        <div className={styles.img_container}>
          <img src={ImgAudio} alt="Imagem representando um microfone" />
        </div>
        <div className={styles.content_container}>
          <h1 className={styles.title}>Transforme seu texto em áudio</h1>
          <p className={styles.description}>
            Escolha o gênero da voz, insira um texto entre 25 e 250 caracteres,
            e clique em gerar.
          </p>
